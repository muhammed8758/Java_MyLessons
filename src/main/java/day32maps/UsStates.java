...
public enum UsStates {
    ...
    UsStates(String statesName, String abbreviation, String capital) {
    ...
    public static String getStateNameFromAbbreviation(String abbreviation) {
       return Arrays.
               ...
               findFirst().// birden fazla opsiyonlarda ilkini verecek
               get().// data tipni String e cevirmek icin kullaniliyor
               getStateName();
    }
    ...
    public static String getStateNameFromCapital(String capital) {
        return Arrays.
                stream(values()).
                filter(UsStates-> UsStates.capital.equals(capital) ).
                findFirst().
                get().
                getStateName();
    }

    //Examples01 Baskenti verilen statenin kisaltmasini ekrana yazdirarak ekrana yazdiriniz
