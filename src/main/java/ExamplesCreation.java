...
/*
       ...
       todo else{
           ...
           List<String> list = new ArrayList<>(Arrays.asList(array)); //Array'i tek satırda Array List'e aktarma
           System.out.println(list);
           String enCokTekrarEdenKarakter="";
           int enCokCounter=0;
           for (String l:list){
               int counter=0;   //Counter her seferinde sıfırlanır
               for (String w:list){
                   if (l.equals(w)){  // Objects.equals(l, w)
                       counter++;
                   }
               }
               if (counter>enCokCounter){
                   enCokCounter=counter;
                   enCokTekrarEdenKarakter=l;
               }
           }
           System.out.println("enCokTekrarEdenKarakter = " + enCokTekrarEdenKarakter);
